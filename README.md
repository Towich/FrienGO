...
- 🔍 **Детальные результаты** - просмотр кто за какой день проголосовал с именами и @username
- 🏁 **Завершение голосования** - закрытие с показом топ-3 самых популярных дней
...
- `/close` - Завершить голосование и показать топ-3 дня
...
5. **Смотрите детали** командой `/results` чтобы увидеть кто за что голосовал
6. **Пингуйте друзей** командой `/ping` при необходимости
7. **Завершите голосование** командой `/close` для показа топ-3 результатов
